...
SELECT 1, '컴퓨터공학과', 'Computer Engineering', '컴퓨터공학과 소개', '010-1234-5678', '본관 101호', '컴퓨터 공학 인재 양성', '9:00 - 18:00', 'https://example.com/map'
...
SELECT 1, 'admin01', 'password123', '관리자', 'admin@example.com', 'ADMIN'
...
ON DUPLICATE KEY UPDATE seminar_id=seminar_id;
