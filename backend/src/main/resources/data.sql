...
VALUES ('권병호', '신경생물학', '010-3178-5629', 'kwonbh@sju.ac.kr', '교수', 'https://home.sejong.ac.kr/kwonbh', '충무관 1128호',
...
VALUES
    -- 권병호 관련 논문
    ('A Proposal for a New Classification of Neurotransmitters', '권병호', 'Journal of Neurobiology',
     ...
     '1223-5671', 1),
    ('Research on Neural Regeneration Mechanisms for Brain Function Recovery', '권병호', 'Neurobiology and Beyond',
     ...
     '5', '23-31',
     '1111-2233', 1),
    ('Study on the Correlation Between Neural Circuits and Brain Disorders', '권병호', 'Neurobiology Insights',
     ...
     '9', '45-52',
     '1011-1211', 1),
    ('Research on Neural Plasticity and Behavioral Changes', '권병호', 'Advanced Neural Studies',
     ...
     '4', '33-40',
     '1212-1345', 1),
    ('Study on the Potential for Neural Network Recovery in Alzheimer’s Models', '권병호', 'Journal of Brain Research',
    ...
    -- 허성문 관련 논문
    ('AI-Based Neural Signal Analysis Study', '허성문', 'Neural Networks Journal', 'AI 기반 신경 신호 분석 연구 논문입니다.',
     ...
     '2', '33-40', '2431-8934', 2),
    ('Applications of AI Technology in Neuroscience', '허성문', 'Journal of Neuroscience', '신경과학의 AI 기술 활용 사례를 다룬 논문입니다.',
    ...
    ('Neuroscience Data Analysis Using Deep Learning', '허성문', 'Artificial Neural Studies',
     ...
     '8', '57-64', '3456-2345', 2),
    ('Integration of Medical AI and Neural Recovery Research', '허성문', 'AI in Neural Pathways',
    ...
    ('Research on Data Normalization Techniques in Neural Networks', '허성문', 'Neurodata Science',
    ...
    -- 추은희 관련 논문
    ('Analysis of Gene Expression Regulation Mechanisms', '추은희', 'Molecular Cell Biology', '유전자 발현 조절 메커니즘을 분석한 논문입니다.',
     ...
     '3', '55-62', '3241-9876', 3),
    ('Molecular Technologies for Solving Protein Folding Problems', '추은희', 'Molecular Innovations',
    ...
    ('Medical Applications of Gene Editing Technologies', '추은희', 'CRISPR Advances', '유전자 편집 기술의 의학적 활용을 다룬 논문입니다.',
     ...
     '6', '74-83', '5647-7842', 3),
    ('Integration of Proteomics Technologies and Molecular Biology', '추은희', 'Genomics and Proteomics',
    ...
    ('Trends in Gene Expression Regulation', '추은희', 'Gene Expression Horizons', '유전자 발현 조절의 최신 동향을 연구한 논문입니다.',
    ...
    ('Research on Cellular Signal Transduction Networks', '정재수', 'Signal Biology Today', '세포 신호 전달 네트워크 연구 논문입니다.',
     ...
     '6', '45-52', '4567-2345', 4),
    ('Analysis of Protein Roles in Intracellular Signal Pathways', '정재수', 'Cellular Dynamics',
     ...
     '3', '67-74', '3456-5647', 4),
    ('Mechanistic Study on Signal Transduction in Cell Membranes', '정재수', 'Membrane Biology Horizons',
    ...
    ('Drug Development through Enzyme Activity Control', '청하람', 'Biochemical Applications', '효소 활성 제어를 통한 약물 개발 연구.',
     ...
     '2', '73-81', '7564-3456', 5),
    ('Bio-material Research Using Enzyme Catalysts', '청하람', 'Enzyme Engineering', '효소 촉매를 활용한 바이오 소재 연구.',
    ...
    ('Biotechnological Applications Using Catalyst Technologies', '청하람', 'Catalyst Research Advances',
    ...
    -- 최수진 및 허병도 관련 논문
    ('Environmental Pollution Remediation Using Biochemical Engineering', '최수진', 'Chemical Biology Trends',
     ...
     '5', '63-72', '2345-9786', 6),
    ('Process Improvement for Bioplastic Production', '최수진', 'Bioengineering Applications', '바이오플라스틱 생산 공정 개선 연구.',
     ...
     '8', '82-90', '7456-3945', 6),
    ('Development of Sustainable Biochemical Engineering Technologies', '최수진', 'Sustainable Bioengineering',
    ...
    ('Cancer Cell Suppression Based on Molecular Biology', '허병도', 'Molecular Innovations', '분자생물학 기반 암 세포 억제 연구.',
     ...
     '6', '71-80', '1234-7890', 7),
    ('Role of Non-Coding Regions in RNA', '허병도', 'RNA Pathway Studies', 'RNA의 비암호화 영역의 역할 분석.',
     ...
     '9', '87-96', '6574-3456', 7),
    ('Gene Therapy Technologies and Cancer Treatment Potential', '허병도', 'Gene Therapy Advances', '유전자 치료 기술과 암 치료 가능성.',
    ...
    ('Bio-Material Development Using Microorganisms', '한은하', 'Microbial Engineering', '미생물을 활용한 바이오 소재 개발.',
     ...
     '3', '43-52', '3456-8790', 8),
    ('Enzyme Production Using Industrial Microorganisms', '한은하', 'Industrial Microbiology', '산업 미생물을 활용한 효소 생산 연구.',
     ...
     '6', '67-75', '4567-9087', 8),
    ('New Applications of Microbial Metabolic Pathways', '한은하', 'Microbial Pathways', '미생물 대사 경로의 새로운 활용 가능성.',
     ...
     '8', '83-92', '5674-9876', 8),
    ('New Approaches to Protein Interactions', '임종득', 'Advanced Biochemistry', '단백질 상호작용의 새로운 접근 방식.',
     ...
     '4', '53-62', '1234-8765', 9),
    ('Mechanisms of Ligand-Protein Interactions', '임종득', 'Protein-Ligand Interactions', '리간드와 단백질의 상호작용 메커니즘.',
     ...
     '7', '77-85', '4567-2345', 9),
    ('Case Studies in Drug Development Based on Protein Structures', '임종득', 'Drug Design Insights',
    ...
    ('Applications of Nanotechnology in Drug Delivery Systems', '어재봉', 'Drug Delivery Systems', '약물전달시스템에서 나노기술 응용 사례.',
    ...
    ('Drug Delivery Potential Using Nanoparticles', '어재봉', 'Nanoparticle Drug Delivery', '나노입자를 활용한 약물 전달 가능성.',
    ...
    ('Next-Generation Drug Delivery Technologies', '어재봉', 'Advanced Drug Systems', '차세대 약물전달기술 연구.',
...
-- Board 더미 데이터 (10개)
INSERT INTO board (title, content, view_count, writer, file_list, category, created_date)
VALUES ('2024-1학기 연계융합전공 신청 및 포기 안내', '연계융합전공 정보는 아래 링크에서 확인 가능합니다.', 31, '이건',
       ...
       ('2페이지', '연구 성과를 공유하는 발표회가 개최됩니다.', 160, '이건',
        '["https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/dummy/%5B%E1%84%80%E1%85%A1%E1%86%BC%E1%84%8B%E1%85%B4%E1%84%82%E1%85%A9%E1%84%90%E1%85%B3%5D+%E1%84%80%E1%85%A7%E1%86%BC%E1%84%8C%E1%85%A6%E1%84%92%E1%85%A1%E1%86%A8_01%E1%84%8C%E1%85%AE%E1%84%8E%E1%85%A1(03%E1%84%8E%E1%85%A1%E1%84%89%E1%85%B5).pdf", "https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/dummy/%5B%E1%84%80%E1%85%A1%E1%86%BC%E1%84%8B%E1%85%B4%E1%84%82%E1%85%A9%E1%84%90%E1%85%B3%5D+%E1%84%80%E1%85%A7%E1%86%BC%E1%84%8C%E1%85%A6%E1%84%92%E1%85%A1%E1%86%A8_02%E1%84%8C%E1%85%AE%E1%84%8E%E1%85%A1(01%E1%84%8E%E1%85%A1%E1%84%89%E1%85%B5).pdf"]',
        'graduate', '2024-05-20 14:00:00'),

       ('제바라', '연구 성과를 공유하는 발표회가 개최됩니다.', 160, '이건',
        '["https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/dummy/%5B%E1%84%80%E1%85%A1%E1%86%BC%E1%84%8B%E1%85%B4%E1%84%82%E1%85%A9%E1%84%90%E1%85%B3%5D+%E1%84%80%E1%85%A7%E1%86%BC%E1%84%8C%E1%85%A6%E1%84%92%E1%85%A1%E1%86%A8_01%E1%84%8C%E1%85%AE%E1%84%8E%E1%85%A1(03%E1%84%8E%E1%85%A1%E1%84%89%E1%85%B5).pdf", "https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/dummy/%5B%E1%84%80%E1%85%A1%E1%86%BC%E1%84%8B%E1%85%B4%E1%84%82%E1%85%A9%E1%84%90%E1%85%B3%5D+%E1%84%80%E1%85%A7%E1%86%BC%E1%84%8C%E1%85%A6%E1%84%92%E1%85%A1%E1%86%A8_02%E1%84%8C%E1%85%AE%E1%84%8E%E1%85%A1(01%E1%84%8E%E1%85%A1%E1%84%89%E1%85%B5).pdf"]',
        'graduate', '2024-05-20 14:00:00'),
...
VALUES
    ...
    ('2024-12-01 13:00:00', '2024-12-01 15:00:00', 'MEETING', '김은희교수님 랩미팅', 1, 'kimeh', 'password123', NOW(), NOW()),
    ('2024-12-02 10:00:00', '2024-12-02 12:00:00', 'MEETING', '김민수교수님 랩미팅', 1, 'kimms', 'password123', NOW(), NOW()),
    ('2024-12-03 14:00:00', '2024-12-03 16:00:00', 'MEETING', '전종훈교수님 랩미팅', 1, 'jeonjh', 'password123', NOW(), NOW()),
    ('2024-12-04 09:30:00', '2024-12-04 11:30:00', 'MEETING', '서민석교수님 랩미팅', 1, 'seoms', 'password123', NOW(), NOW()),
    ('2024-12-05 15:00:00', '2024-12-05 17:00:00', 'MEETING', '홍성무교수님 랩미팅', 1, 'hongsm', 'password123', NOW(), NOW()),
    ('2024-12-06 10:30:00', '2024-12-06 12:30:00', 'MEETING', '김은희교수님 랩미팅', 1, 'kimeh', 'password123', NOW(), NOW()),
    ('2024-12-07 13:30:00', '2024-12-07 15:30:00', 'MEETING', '김민수교수님 랩미팅', 1, 'kimms', 'password123', NOW(), NOW()),
    ('2024-12-08 11:00:00', '2024-12-08 13:00:00', 'MEETING', '전종훈교수님 랩미팅', 1, 'jeonjh', 'password123', NOW(), NOW()),
    ('2024-12-09 16:00:00', '2024-12-09 18:00:00', 'MEETING', '서민석교수님 랩미팅', 1, 'seoms', 'password123', NOW(), NOW());
