...
VALUES
    (1, '첫 번째 게시글', '게시글 내용 1', 10, '작성자1', 'file1.txt', '2024-01-01', '공지사항', 1),
    (2, '두 번째 게시글', '게시글 내용 2', 20, '작성자2', 'file2.txt', '2024-01-02', '소식', 1),
    (3, '세 번째 게시글', '게시글 내용 3', 30, '작성자3', 'file3.txt', '2024-01-03', '자료', 1),
    (4, '네 번째 게시글', '게시글 내용 4', 40, '작성자4', 'file4.txt', '2024-01-04', '공지사항', 1),
    (5, '다섯 번째 게시글', '게시글 내용 5', 50, '작성자5', 'file5.txt', '2024-01-05', '소식', 1),
    (6, '여섯 번째 게시글', '게시글 내용 6', 60, '작성자6', 'file6.txt', '2024-01-06', '자료', 1),
    (7, '일곱 번째 게시글', '게시글 내용 7', 70, '작성자7', 'file7.txt', '2024-01-07', '공지사항', 1),
    (8, '여덟 번째 게시글', '게시글 내용 8', 80, '작성자8', 'file8.txt', '2024-01-08', '소식', 1),
    (9, '아홉 번째 게시글', '게시글 내용 9', 90, '작성자9', 'file9.txt', '2024-01-09', '자료', 1),
    (10, '열 번째 게시글', '게시글 내용 10', 100, '작성자10', 'file10.txt', '2024-01-10', '공지사항', 1);
