...
VALUES
    ...
    ('신경 전달 물질의 새로운 분류', '권병호', 'Journal of Neurobiology', '신경 전달 물질의 새로운 분류를 제안한 논문입니다.', 'https://example.com/thesis1',
     '2024-01-15', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12345a.jpg', 'Vol. 12', 'No. 1', 'pp. 15-22',
     '1223-5671', 1),
    ('뇌 기능 회복을 위한 신경 재생 연구', '권병호', 'Neurobiology and Beyond', '뇌 기능 회복을 위한 신경 재생 메커니즘 연구 논문입니다.', 'https://example.com/thesis11',
     '2024-11-01', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12355k.jpg', 'Vol. 14', 'No. 5', 'pp. 23-31',
     '1111-2233', 1),
    ('신경 회로와 뇌질환 연구', '권병호', 'Neurobiology Insights', '신경 회로와 뇌질환 상관 연구를 다룬 논문입니다.', 'https://example.com/thesis21',
     '2024-05-10', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12445z.jpg', 'Vol. 17', 'No. 9', 'pp. 45-52',
     '1011-1211', 1),
    ('신경 플라스틱성과 행동 변화', '권병호', 'Advanced Neural Studies', '신경 플라스틱성과 행동 변화를 연구한 논문입니다.', 'https://example.com/thesis31',
     '2024-08-12', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12532a.jpg', 'Vol. 23', 'No. 4', 'pp. 33-40',
     '1212-1345', 1),
    ('알츠하이머 모델의 신경망 회복', '권병호', 'Journal of Brain Research', '알츠하이머 모델의 신경망 회복 가능성을 연구한 논문입니다.', 'https://example.com/thesis41',
     '2024-02-14', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12678b.jpg', 'Vol. 28', 'No. 6', 'pp. 75-85',
     '1432-9876', 1),

    -- 허성문 관련 논문
    ('AI 기반 신경 신호 분석', '허성문', 'Neural Networks Journal', 'AI 기반 신경 신호 분석 연구 논문입니다.', 'https://example.com/thesis2',
     '2024-02-10', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12346b.jpg', 'Vol. 18', 'No. 2', 'pp. 33-40',
     '2431-8934', 2),
    ('신경과학의 AI 기술 활용 사례', '허성문', 'Journal of Neuroscience', '신경과학의 AI 기술 활용 사례를 다룬 논문입니다.', 'https://example.com/thesis12',
     '2024-11-02', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12356l.jpg', 'Vol. 19', 'No. 12', 'pp. 227-235',
     '1212-3344', 2),
    ('딥러닝 기반 신경 데이터 분석', '허성문', 'Artificial Neural Studies', '딥러닝을 활용한 신경과학 데이터 분석 논문입니다.', 'https://example.com/thesis22',
     '2024-06-15', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12457c.jpg', 'Vol. 22', 'No. 8', 'pp. 57-64',
     '3456-2345', 2),
    ('의료용 AI와 신경 회복 융합 연구', '허성문', 'AI in Neural Pathways', '의료용 AI와 신경 회복의 융합 연구를 다룬 논문입니다.', 'https://example.com/thesis32',
     '2024-09-20', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12565d.jpg', 'Vol. 25', 'No. 11', 'pp. 67-75',
     '4456-5678', 2),
    ('신경망 데이터 정규화 기법 연구', '허성문', 'Neurodata Science', '신경망에서 데이터 정규화 기법 연구를 다룬 논문입니다.', 'https://example.com/thesis42',
     '2024-03-10', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12689e.jpg', 'Vol. 30', 'No. 5', 'pp. 92-102',
     '5647-7869', 2),

    -- 추은희 관련 논문
    ('유전자 발현 조절 메커니즘 분석', '추은희', 'Molecular Cell Biology', '유전자 발현 조절 메커니즘을 분석한 논문입니다.', 'https://example.com/thesis3',
     '2024-03-20', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12347c.jpg', 'Vol. 21', 'No. 3', 'pp. 55-62',
     '3241-9876', 3),
    ('단백질 접힘 문제 해결 연구', '추은희', 'Molecular Innovations', '단백질 접힘 문제를 해결하기 위한 분자 기술 연구 논문입니다.', 'https://example.com/thesis13',
     '2024-11-03', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12357m.jpg', 'Vol. 25', 'No. 1', 'pp. 237-245',
     '1313-4455', 3),
    ('유전자 편집 기술의 의학적 활용', '추은희', 'CRISPR Advances', '유전자 편집 기술의 의학적 활용을 다룬 논문입니다.', 'https://example.com/thesis23',
     '2024-07-15', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12478f.jpg', 'Vol. 26', 'No. 6', 'pp. 74-83',
     '5647-7842', 3),
    ('프로테오믹스와 분자 생물학 융합', '추은희', 'Genomics and Proteomics', '프로테오믹스 기술과 분자 생물학의 융합을 다룬 논문입니다.', 'https://example.com/thesis33',
     '2024-10-25', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12589g.jpg', 'Vol. 29', 'No. 10', 'pp. 102-111',
     '8756-3498', 3),
    ('유전자 발현 조절 최신 동향', '추은희', 'Gene Expression Horizons', '유전자 발현 조절의 최신 동향을 연구한 논문입니다.', 'https://example.com/thesis43',
     '2024-04-18', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12723h.jpg', 'Vol. 31', 'No. 7', 'pp. 122-130',
     '7865-6578', 3),

    -- 정재수 관련 논문
    ('세포 신호 전달 네트워크 연구', '정재수', 'Signal Biology Today', '세포 신호 전달 네트워크 연구 논문입니다.', 'https://example.com/thesis24',
     '2024-05-12', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12701x.jpg', 'Vol. 12', 'No. 6', 'pp. 45-52',
     '4567-2345', 4),
    ('단백질의 역할 분석', '정재수', 'Cellular Dynamics', '세포 내 신호 전달 경로에서 단백질의 역할 분석.', 'https://example.com/thesis34',
     '2024-07-20', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12845y.jpg', 'Vol. 14', 'No. 3', 'pp. 67-74',
     '3456-5647', 4),
    ('세포막 신호 전달 메커니즘', '정재수', 'Membrane Biology Horizons', '세포막 신호 전달 메커니즘 연구.', 'https://example.com/thesis44',
     '2024-08-18', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12989z.jpg', 'Vol. 17', 'No. 9', 'pp. 95-104',
     '1234-6543', 4),

    -- 청하람 관련 논문
    ('효소 활성 제어와 약물 개발', '청하람', 'Biochemical Applications', '효소 활성 제어를 통한 약물 개발 연구.', 'https://example.com/thesis25',
     '2024-05-20', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12350o.jpg', 'Vol. 13', 'No. 2', 'pp. 73-81',
     '7564-3456', 5),
    ('효소 촉매 활용 바이오 소재 연구', '청하람', 'Enzyme Engineering', '효소 촉매를 활용한 바이오 소재 연구.', 'https://example.com/thesis35',
     '2024-07-25', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12760p.jpg', 'Vol. 20', 'No. 4', 'pp. 102-110',
     '5647-7654', 5),
    ('촉매 기술과 생명 공학 응용', '청하람', 'Catalyst Research Advances', '촉매 기술을 활용한 생명 공학 응용.', 'https://example.com/thesis45',
     '2024-09-01', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12570q.jpg', 'Vol. 23', 'No. 7', 'pp. 92-101',
     '8754-7865', 5),
    -- 최수진 관련 논문
    ('생물화공을 활용한 환경 오염 정화', '최수진', 'Chemical Biology Trends', '생물화공을 활용한 환경 오염 정화 기술.', 'https://example.com/thesis26',
     '2024-05-15', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12350k.jpg', 'Vol. 19', 'No. 5', 'pp. 63-72',
     '2345-9786', 6),
    ('바이오플라스틱 생산 공정 개선', '최수진', 'Bioengineering Applications', '바이오플라스틱 생산 공정 개선 연구.', 'https://example.com/thesis36',
     '2024-08-10', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12761l.jpg', 'Vol. 21', 'No. 8', 'pp. 82-90',
     '7456-3945', 6),
    ('지속 가능한 생물화공 기술 개발', '최수진', 'Sustainable Bioengineering', '지속 가능한 생물화공 기술 개발 논문.', 'https://example.com/thesis46',
     '2024-09-25', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12571m.jpg', 'Vol. 24', 'No. 10', 'pp. 112-120',
     '5647-7865', 6),

    -- 허병도 관련 논문
    ('분자생물학 기반 암 세포 억제', '허병도', 'Molecular Innovations', '분자생물학 기반 암 세포 억제 연구.', 'https://example.com/thesis27',
     '2024-06-01', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12351n.jpg', 'Vol. 15', 'No. 6', 'pp. 71-80',
     '1234-7890', 7),
    ('RNA 비암호화 영역의 역할 분석', '허병도', 'RNA Pathway Studies', 'RNA의 비암호화 영역의 역할 분석.', 'https://example.com/thesis37',
     '2024-07-20', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12762o.jpg', 'Vol. 18', 'No. 9', 'pp. 87-96',
     '6574-3456', 7),
    ('유전자 치료 기술과 암 치료', '허병도', 'Gene Therapy Advances', '유전자 치료 기술과 암 치료 가능성.', 'https://example.com/thesis47',
     '2024-10-05', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12572p.jpg', 'Vol. 21', 'No. 11', 'pp. 103-112',
     '7864-5678', 7),

    -- 한은하 관련 논문
    ('미생물을 활용한 바이오 소재 개발', '한은하', 'Microbial Engineering', '미생물을 활용한 바이오 소재 개발.', 'https://example.com/thesis28',
     '2024-05-25', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12352q.jpg', 'Vol. 17', 'No. 3', 'pp. 43-52',
     '3456-8790', 8),
    ('산업 미생물 효소 생산 연구', '한은하', 'Industrial Microbiology', '산업 미생물을 활용한 효소 생산 연구.', 'https://example.com/thesis38',
     '2024-08-05', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12763r.jpg', 'Vol. 20', 'No. 6', 'pp. 67-75',
     '4567-9087', 8),
    ('미생물 대사 경로 활용 가능성', '한은하', 'Microbial Pathways', '미생물 대사 경로의 새로운 활용 가능성.', 'https://example.com/thesis48',
     '2024-09-15', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12573s.jpg', 'Vol. 22', 'No. 8', 'pp. 83-92',
     '5674-9876', 8),

    -- 임종득 관련 논문
    ('단백질 상호작용의 새로운 접근', '임종득', 'Advanced Biochemistry', '단백질 상호작용의 새로운 접근 방식.', 'https://example.com/thesis29',
     '2024-06-10', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12353t.jpg', 'Vol. 16', 'No. 4', 'pp. 53-62',
     '1234-8765', 9),
    ('리간드와 단백질의 상호작용', '임종득', 'Protein-Ligand Interactions', '리간드와 단백질의 상호작용 메커니즘.', 'https://example.com/thesis39',
     '2024-07-15', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12764u.jpg', 'Vol. 19', 'No. 7', 'pp. 77-85',
     '4567-2345', 9),
    ('단백질 구조 기반 신약 개발', '임종득', 'Drug Design Insights', '단백질 구조 기반 신약 개발 사례.', 'https://example.com/thesis49',
     '2024-10-25', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12574v.jpg', 'Vol. 22', 'No. 11', 'pp. 98-107',
     '9876-1234', 9),

    -- 어재봉 관련 논문
    ('나노기술 활용 약물전달 시스템', '어재봉', 'Drug Delivery Systems', '약물전달시스템에서 나노기술 응용 사례.', 'https://example.com/thesis30',
     '2024-06-25', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12354w.jpg', 'Vol. 18', 'No. 5', 'pp. 71-79',
     '4567-9087', 10),
    ('나노입자 활용 약물 전달 연구', '어재봉', 'Nanoparticle Drug Delivery', '나노입자를 활용한 약물 전달 가능성.', 'https://example.com/thesis40',
     '2024-08-12', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12765x.jpg', 'Vol. 20', 'No. 9', 'pp. 87-94',
     '5678-2345', 10),
    ('차세대 약물전달 기술 연구', '어재봉', 'Advanced Drug Systems', '차세대 약물전달기술 연구.', 'https://example.com/thesis50',
     '2024-10-30', 'https://dibb-bucket.s3.ap-northeast-2.amazonaws.com/is_12575y.jpg', 'Vol. 23', 'No. 12', 'pp. 102-110',
     '2345-9087', 10);
