...
INSERT INTO users (name, major, phone)
VALUES ('장영재', '컴퓨터공학과', '010-1111-1111'),
       ('이진', '원자력공학과', '010-2222-2222'),
       ('박지민', '정보통신공학과', '010-3333-3333'),
       ('최동훈', '컴퓨터공학과', '010-4444-4444'),
       ('정미경', '소프트웨어학과', '010-5555-5555');
