...
-- User 더미 데이터 (10개)
INSERT INTO user (student_id, name, major, phone)
VALUES
    ('20180001', '사용자1', '컴퓨터공학과', '010-1111-1111'),
    ('20180002', '사용자2', '컴퓨터공학과', '010-2222-2222'),
    ('20180003', '사용자3', '컴퓨터공학과', '010-3333-3333'),
    ('20180004', '사용자4', '컴퓨터공학과', '010-4444-4444'),
    ('20180005', '사용자5', '컴퓨터공학과', '010-5555-5555'),
    ('20180006', '사용자6', '컴퓨터공학과', '010-6666-6666'),
    ('20180007', '사용자7', '컴퓨터공학과', '010-7777-7777'),
    ('20180008', '사용자8', '컴퓨터공학과', '010-8888-8888'),
    ('20180009', '사용자9', '컴퓨터공학과', '010-9999-9999'),
    ('20180010', '사용자10', '컴퓨터공학과', '010-1010-1010');